...
public class MainActivity extends AppCompatActivity {
    ...
    public class GithubQueryTask extends AsyncTask<URL, Void, String> {
        ...
        protected void onPreExecute() {
            MainActivity.this.mSearchProgressBar.setVisibility(View.VISIBLE);
        }
        ...
        protected void onPostExecute(String githubSearchResults) {
            ...
            MainActivity.this.mSearchProgressBar.setVisibility(View.INVISIBLE);

            if (githubSearchResults != null && !githubSearchResults.equals("")) {
                // DONE (17) Call showJsonDataView if we have valid, non-null results
                MainActivity.this.showJsonDataView(githubSearchResults);
            } else {
                // DONE (16) Call showErrorMessage if the result is null in onPostExecute
                MainActivity.this.showErrorMessage("Failed to fetch the search results.");
            }
        }
    }
