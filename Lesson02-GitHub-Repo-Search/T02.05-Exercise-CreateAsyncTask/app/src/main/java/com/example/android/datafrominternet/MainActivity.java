...
public class MainActivity extends AppCompatActivity {
    ...
    public class GithubQueryTask extends AsyncTask<URL, Void, String> {
        ...
        protected String doInBackground(URL... urls) {
            ...
            String searchResultsText = null;
            try {
                searchResultsText = NetworkUtils.getResponseFromHttpUrl(searchUrl);
            } catch (IOException e) {
                e.printStackTrace();
            }
        ...
        @Override
        protected void onPostExecute(String searchResultsText) {
            MainActivity.this.mSearchResultsTextView.setText(searchResultsText);
        }
    }
